...
UNIFI_DEVICES = [
    ...
    },
    {
        ...
        "outlet_ac_power_budget": 150.0,
        "outlet_ac_power_consumption": 45.0,
        "radio_table": [],
    },
]
...
UNIFI_FIREWALL_POLICIES = [
    {
        ...
        "destination_matching_target": "INTERNET",
        "client_macs": None,
        "site_id": "default",
    },
    {
...
# Test data for UniFi network (VLAN) configurations, shaped like the real
# /rest/networkconf response.
