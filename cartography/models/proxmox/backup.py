...
class ProxmoxBackupJobNodeProperties(CartographyNodeProperties):
    ...
    prune_backups: PropertyRef = PropertyRef("prune_backups")  # Retention settings
...
class ProxmoxBackupJobToClusterRel(CartographyRelSchema):
    ...
    properties: ProxmoxBackupJobToClusterRelProperties = ProxmoxBackupJobToClusterRelProperties()
...
class ProxmoxBackupJobToStorageRel(CartographyRelSchema):
    ...
    properties: ProxmoxBackupJobToStorageRelProperties = ProxmoxBackupJobToStorageRelProperties()
...
class ProxmoxBackupJobSchema(CartographyNodeSchema):
    ...
    sub_resource_relationship: ProxmoxBackupJobToClusterRel = ProxmoxBackupJobToClusterRel()
