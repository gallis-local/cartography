    ...
    def _build_app(self, visible_panels: set[str]) -> typer.Typer:
        ...
        def run(
            ...
            unifi_host: Annotated[
                ...
                typer.Option(
                    "--unifi-host",
                    help="UniFi controller host (e.g., localhost or 192.168.1.1). Required if using the UniFi module.",
            ...
            unifi_password_env_var: Annotated[
                ...
                typer.Option(
                    ...
                    help="Environment variable name containing the UniFi controller password.",
                    rich_help_panel=PANEL_UNIFI,
                    hidden=PANEL_UNIFI not in visible_panels,
                ),
            ] = None,
            ...
            unifi_verify_ssl: Annotated[
                ...
                typer.Option(
                    "--unifi-verify-ssl",
                    help="Verify SSL certificates when connecting to UniFi controller.",
                    rich_help_panel=PANEL_UNIFI,
                    hidden=PANEL_UNIFI not in visible_panels,
                ),
            ] = False,
