    ...
    def _build_app(self, visible_panels: set[str]) -> typer.Typer:
        ...
        def run(
            ...
            proxmox_host: Annotated[
                ...
                typer.Option(
                    "--proxmox-host",
                    help="Proxmox host to sync (e.g., 192.168.1.100).",
            ...
            proxmox_user: Annotated[
                ...
                typer.Option(
                    "--proxmox-user",
                    help="Proxmox user for authentication.",
                    rich_help_panel=PANEL_PROXMOX,
                    hidden=PANEL_PROXMOX not in visible_panels,
                ),
            ] = "root@pam",
            proxmox_token_name_env_var: Annotated[
                ...
                typer.Option(
                    ...
                    help="Environment variable name containing the Proxmox API token name.",
                    rich_help_panel=PANEL_PROXMOX,
                    hidden=PANEL_PROXMOX not in visible_panels,
                ),
            ] = None,
            proxmox_token_value_env_var: Annotated[
                ...
                typer.Option(
                    ...
                    help="Environment variable name containing the Proxmox API token value.",
                    rich_help_panel=PANEL_PROXMOX,
                    hidden=PANEL_PROXMOX not in visible_panels,
                ),
            ] = None,
            proxmox_password_env_var: Annotated[
                ...
                typer.Option(
                    ...
                    help="Environment variable name containing the Proxmox password.",
                    rich_help_panel=PANEL_PROXMOX,
                    hidden=PANEL_PROXMOX not in visible_panels,
                ),
            ] = None,
            proxmox_verify_ssl: Annotated[
                ...
                typer.Option(
                    "--proxmox-verify-ssl",
                    help="Verify SSL certificates when connecting to Proxmox.",
                    rich_help_panel=PANEL_PROXMOX,
                    hidden=PANEL_PROXMOX not in visible_panels,
                ),
            ] = True,
            proxmox_enable_guest_agent: Annotated[
                ...
                typer.Option(
                    ...
                    help="Enable QEMU Guest Agent data collection for VMs.",
                    rich_help_panel=PANEL_PROXMOX,
                    hidden=PANEL_PROXMOX not in visible_panels,
                ),
            ] = False,
            ...
            if proxmox_host:
                if proxmox_token_name_env_var and proxmox_token_value_env_var:
                    logger.debug(
                        "Reading Proxmox API token from environment variables %s and %s",
                        proxmox_token_name_env_var,
                        proxmox_token_value_env_var,
                    )
                    proxmox_token_name = os.environ.get(proxmox_token_name_env_var)
                    proxmox_token_value = os.environ.get(proxmox_token_value_env_var)
                elif proxmox_password_env_var:
                    logger.debug(
                        "Reading Proxmox password from environment variable %s",
                        proxmox_password_env_var,
                    )
                    proxmox_password = os.environ.get(proxmox_password_env_var)
