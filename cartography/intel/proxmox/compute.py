...
def get_guest_agent_info(
    ...
    Returns empty dict if VM is not running or agent is not available.
    ...
    try:
        ...
        # VM not running, agent not installed, or agent not responding
        logger.debug(
...
def sync(
    ...
    :return: List of all VMs/containers (for use by snapshot sync)
    """
