...
@timeit
def get_node_firewall_rules(proxmox_client, node_name: str) -> list[dict[str, Any]]:
    """
...
@timeit
def get_cluster_ipsets(proxmox_client) -> list[dict[str, Any]]:
    """
...
@timeit
def get_ipset_cidrs(proxmox_client, ipset_name: str) -> list[dict[str, Any]]:
    """
