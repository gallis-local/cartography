...
CREATE INDEX IF NOT EXISTS FOR (n:ProxmoxCluster) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:ProxmoxCluster) ON (n.lastupdated);
CREATE INDEX IF NOT EXISTS FOR (n:ProxmoxNode) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:ProxmoxNode) ON (n.lastupdated);
CREATE INDEX IF NOT EXISTS FOR (n:ProxmoxVM) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:ProxmoxVM) ON (n.vmid);
CREATE INDEX IF NOT EXISTS FOR (n:ProxmoxVM) ON (n.name);
CREATE INDEX IF NOT EXISTS FOR (n:ProxmoxVM) ON (n.lastupdated);
CREATE INDEX IF NOT EXISTS FOR (n:ProxmoxDisk) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:ProxmoxDisk) ON (n.lastupdated);
CREATE INDEX IF NOT EXISTS FOR (n:ProxmoxNetworkInterface) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:ProxmoxNetworkInterface) ON (n.lastupdated);
CREATE INDEX IF NOT EXISTS FOR (n:ProxmoxStorage) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:ProxmoxStorage) ON (n.name);
CREATE INDEX IF NOT EXISTS FOR (n:ProxmoxStorage) ON (n.lastupdated);
